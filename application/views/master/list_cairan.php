<div class="page-title text-right">
	<h4>Master Data <i class="ti-angle-right"></i> Master Cairan</h4>
</div>
<div class="container">
	<div class="card">
		<div class="card-block text-dark">
			<h4 class="card-title">Master Cairan</h4>
			<div class="card-body">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Tambah Master Cairan</h5>
			...
			<form id="xyz">
				<div class="modal-body">
					<div class="form-group row">
						<label for="form-1-1" class="col-md-2 control-label">Nama Cairan</label>
						<div class="col-md-10">
...
<script>
	...
	$(document).on('click', '.hapus', function() {
		...
		if(conf == true) {
			$.post("<?= site_url('master/master_data/hapus_jenis_barang/cairan/') ?>"+id, '', function(d) {
				if(d.s == 'sukses') {
					alert(d.m);
					location.reload();
				} else {
	...
	$('#xyy').on('submit', function(e) {
		...
		$.ajax({
			url: "<?= site_url('master/master_data/update_jenis_barang/cairan') ?>",
			type: "POST",
			data:  $("#xyy").serialize(),
			cache: false,
			dataType: 'json',
	...
	$('#xyz').on('submit', function(e) {
		...
		$.ajax({
			url: "<?= site_url('master/master_data/simpan_jenis_barang/cairan') ?>",
			type: "POST",
			data:  $("#xyz").serialize(),
			cache: false,
			dataType: 'json',
